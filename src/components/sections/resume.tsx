			...
			<div className="flex flex-1 flex-col lg:flex-row">
				...
				<div className={`${COLUMN} gap-12`}>
					<Reveal className={`${MEASURE} flex flex-col gap-6`}>
						...
						<p className="text-text-secondary text-[15px] leading-[1.6] sm:text-[16px]">{resume.lead}</p>
					</Reveal>

					<Reveal delay={120} className="flex flex-col gap-1">
						<p className="text-text-secondary font-mono text-[14px] font-light">{resume.direct.label}</p>
