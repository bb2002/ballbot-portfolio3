...
import { archiveProjects, featuredProjects, projectList } from "@/data/portfolio";
import { ImagePlaceholder, ThumbFrame } from "@/components/ui/image-placeholder";
...
function ArchiveCard({ project }: { project: (typeof archiveProjects)[number] }) {
	return (
