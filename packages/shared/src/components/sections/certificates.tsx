...
export function Certificates({ content }: { content: CertificatesContent }) {
	return (
		<section id="certificates" data-section aria-labelledby="awards-label">
			<SectionLabel id="awards-label">{content.awardsLabel}</SectionLabel>
			...
			{content.scholarship ? (
				<>
					<SectionLabel>{content.scholarship.label}</SectionLabel>
							...
							<div className={GRID}>
								<div className={WIDE_CELL}>
									<Reveal className="flex min-w-0 flex-1">
										<FeaturedAward award={content.scholarship.award} />
									</Reveal>
								</div>
							</div>
						</div>
			...
			<SectionLabel>{content.certificationsLabel}</SectionLabel>
