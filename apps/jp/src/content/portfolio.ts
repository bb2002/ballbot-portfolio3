...
/** The words outside the sections: the JSON-LD name, the skip link and the 404 page. */
...
export const hero: HeroContent = {
	...
	headline: "816万ユーザーの\nサービスを支えてきた",
	// Where this wraps (1440 and phone widths), the no-break space keeps the
	// name whole: the break falls before the parenthesis, not inside KIM SUBEEN.
	subtitle: "ソフトウェアエンジニアのキム・スビン（KIM\u00a0SUBEEN）です。",
	actions: {
		primary: { label: "歩みを見る", href: "#journey" },
		secondary: [{ label: "GitHub ↗", href: "https://github.com/bb2002" }],
	},
	otherMarket: {
		lang: "ko",
		lead: "한국에서 보고 계신가요? ",
	...
	blocks: [
		{
			...
			items: [
				...
				{ emphasis: "希望勤務地", detail: "日本全国" },
			],
		},
		{
			value: "2 Years",
			caption: "Nudge Healthcare（韓国のヘルスケア企業）のバックエンド",
			items: [
				...
				{ emphasis: "メモリ 32GB を使い切って停止していた", detail: "API サーバーの正常化", href: "/experience/api-memory" },
			],
		},
		{
			value: "4.43 / 4.5",
			caption: "江原大学校 コンピュータ工学科 在学中",
			items: [{ emphasis: "2027年2月", detail: "卒業予定" }],
		},
	],
};
...
const SCREEN_TRANSLATOR_SCREENS: readonly Media[] = [
	{
		...
		note: "スマートフォンを振るとすぐに画面をキャプチャし、画像を OCR にかけてテキストを抽出し、翻訳 API で翻訳してオーバーレイの形でユーザーに表示するアプリです。\n\nGoogle 翻訳の API で翻訳を提供していましたが、API キーの管理に関する知識がなく、クライアントアプリにそのままキーを保存していました。1,000人ほどがダウンロードした頃にキーが流出し、1日に数万円ものサーバー費用が発生しているのを見て、すぐにサービスを取り下げてしまったというハプニングがありました。",
	},
	{
	...
	},
	{
		...
		width: 560,
		height: 996,
		alt: "基本設定の画面。翻訳する言語の組み合わせと認識精度、翻訳のディレイ、AI 翻訳を使うかどうかを選ぶ",
	},
	{
...
const cosmoStory: ProjectStoryContent = {
	...
	highlights: [
		...
		"ユーザー1人のために高性能マシンを24時間動かしておかなければならない、というコストの問題を解決する",
		"フラッグシップモデルを高効率モデルに替えながら、ノートの品質は守り抜く",
	],
	facts: [
		{ term: "参加人数", detail: "1人（個人開発）" },
		{ term: "開発期間", detail: "2025.05 ~ 現在" },
		{ term: "主な技術", detail: "Cloudflare Workers, R2, Containers" },
		{ term: "受賞", detail: "全国大学ソフトウェア成果共有フォーラム（韓国） 最優秀賞" },
	],
	motivation: [
		"副専攻のクラウド学科は、授業のほとんどが動画講義で行われていました。基礎科目はすでに知っている内容が大半なのに、試験と課題のために、知っている講義を最初から流し直さなければなりませんでした。",
		"しばらくは講義動画をダウンロードして、既存の要約サービスに入れて使っていました。試験の2週間前にまとめて使い、その後2か月は手もつけないのが学生の使い方なのに、月額のサブスクリプションなので、使わない日にも料金を払わなければなりませんでした。動画の読み込みから要約までを一度に済ませつつ、従量課金（Pay As You Go）型のサービスを作ってみよう、というのがコスモのノートの始まりでした。",
	],
	steps: [
		{
			period: "2025.05",
			...
			paragraphs: [
				"最初は、講義の視聴画面の右側にダウンロードボタンを付けるブラウザエクステンションを作りました。ボタンを押すとエクステンションがウェブの通信内容を読み、ストリーミングファイルのアドレスをサーバーに送ります。サーバーは .ts（MPEG-TS）形式のストリーミングファイルをダウンロードして mp4 にエンコードし、ダウンロードリンクを返す、というシンプルな構成でした。",
				"エクステンションを作って公開し、コミュニティに投稿すると、480人以上の学友が「いいね」を押してくれました。ダウンロードしかできないプログラムがこれだけ注目されたのは、この不便さが自分だけの問題ではない証拠でした。",
			],
		},
		{
			period: "2025.08",
		...
		},
		{
			...
			paragraphs: [
				...
				"そこで、ウェブサイトだけで動くように大がかりに作り直しました。学校サイトのログイン情報と講座の URL を受け取ると、Cloudflare Browser で直接ログインし、パケットを検知して動画を見つけ出す仕組みです。ログイン情報は保存しないようにしました。ソフトウェアは複雑になりバグも増えましたが、エクステンションをなくしたことで、使いやすさは比べものにならないほど良くなりました。",
			],
		},
		{
			period: "2026.09",
	...
	architecture: {
		...
		items: [
			...
			{
				title: "ユーザー1人のために高性能マシンを24時間動かしておかなければならない、というコストの問題を解決する",
				body: [
					...
					"この構成が、そのまま料金プランになりました。2時間の動画で、約130円かかります。他社のサービスが3時間分の動画を分析するのに月790円を求めることを考えると、試験期間にまとめて使う学生にとってはとても合理的な仕組みです。インフラも使った分だけ請求される構成なので、持続可能なシステムです。",
				],
			},
			{
				title: "フラッグシップモデルを高効率モデルに替えながら、ノートの品質は守り抜く",
				body: [
					"開発初期は、Claude のようなフラッグシップモデルを使っていました。プロンプトのチューニングやタイムラインの整理をあまりしなくても満足できる結果が出ましたが、ノートを1本生成するのにお金がかかりすぎました。2時間の動画を Claude で要約して130円で提供するのは、慈善事業でもなければ成り立ちません。",
					COSMO_PIPELINE,
					...
					"コンテキストのせいで品質が落ちる問題は解決しましたが、推論能力の差が問題でした。そこで Fable のようなフラッグシップモデルと今のパイプラインの結果を比較するハーネスを作り、定期的に実行しています。Fable ほどの性能は出せませんが、コストのわりに良い品質が出ています。",
				],
			},
		],
	},
...
const ENQOR_FIGURES = {
	billing: {
		...
		alt: "通話の課金シーケンス。発信者と受信者が両側に、サーバーが中央にあり、毎秒 ping がやり取りされる間はサーバーが課金し、ping が3回届かなければ課金を止め、再び届けば再開し、7回届かなければ通話を終える",
	},
	balance: {
		...
		height: 1040,
		caption: "通話セッションの残高",
		alt: "残高処理の構成図。通話が始まると DB の残高をロックし、Redis のセッションに複製する。残高は毎秒減り、チャージすると増え、プレゼントすると減る。残り時間は残高から計算してクライアントに返し、通話が終わると DB に書き戻す",
	},
	docs: {
	...
	harness: {
		...
		width: 2400,
		height: 640,
		caption: "先にウェブで画面を組むハーネス",
		alt: "ハーネスのフロー図。エージェントが画面を expo web で実装すると、批判的エージェントが Figma と照らし合わせて評価し、直すところがあればエージェントに差し戻し、合格すればアプリに移す",
	},
} as const satisfies Record<string, Media>;
...
const enqorStory: ProjectStoryContent = {
	...
	highlights: [
		"安定して通話がつながっている間だけ、秒単位で課金する",
		"AI の成果物を、人手をボトルネックにせずに検証する",
	],
	facts: [
		{ term: "参加人数", detail: "3人" },
	...
	motivation: [
		"最近は、悩みがあるとまず ChatGPT に聞きます。ところが、いざ心が乱れているときは AI 特有の心のこもらない受け答えにすぐ疲れてしまい、医療や受験のように責任の伴う相談では、AI の答えをそのまま信じるのも難しいものでした。人と話すべき会話は、まだ残っています。",
		"医師のような専門家から恋愛経験の長い人まで、それぞれが自信のある分野で他の人の悩みを聞き、収益を得られる場が必要だと考えました。会話プラットフォームを開発するために Align Networks に参画し、アプリとサーバーの開発を担当しています。ただし、enqor は人が直接プログラミングしたものではありません。企画書とデザインを AI エージェントが読めるようにし、エージェントが出した成果物を検証する環境を作ることが私の仕事でした。",
	],
	architecture: {
		label: "Architecture",
		items: [
			{
				title: "安定して通話がつながっている間だけ、秒単位で課金する",
				body: [
					"enqor の中核となる機能は、ビデオ・音声通話です。ストリーミングは Agora を使ったので難しくありませんでしたが、課金のパイプラインは自分で作らなければならない課題でした。モバイルは通信状態が悪くなることが多いため、正常につながっていた時間の分だけ課金する必要があり、さらに秒単位の課金まで求められました。",
					ENQOR_FIGURES.billing,
					"まず、「安定した通話」とは何かを決めなければなりません。これは、サーバーとクライアントがやり取りする ping で定義しました。どちらか一方の参加者でも ping が3回届かなければ接続に問題があると判断し、課金を止めます。7回届かなければ通話が切れたと判断し、セッションを終了するようにしました。",
					"次の問題は、毎秒課金という要件です。最初は、通話時間全体から不安定だった時間を引き、通話が終わった後にデータベースを一度だけ更新するつもりでした。ところが、要件が思った以上に複雑でした。通話中にアプリ内通貨のクラップをチャージできる必要があり、チャージしたクラップで互いにプレゼントもでき、通話可能な時間が20秒未満になれば、もうすぐ通話が終わることも知らせなければなりません。チャージ、消費、照会がすべてリアルタイムで行われる必要があるため、残りのクラップを読み書きの軽いどこかに保存して処理するのが簡単だと判断しました。",
					ENQOR_FIGURES.balance,
					"通話が始まると、発信者のクラップ残高を変更できないようにします。現在の残高を読んで Redis の通話セッションに複製しておくと、この値が通話中に発信者が使える残高の基準になります。毎秒この値を減らして課金し、チャージやプレゼントがあればこの値を更新し続けます。チャージは決済の記録を残す必要があるので、DB にも別途残します。残りの通話時間も、この値をもとに計算してクライアントに返します。通話が終わったら、残高を DB に書き戻します。チャージとプレゼントを除けば、通話1件あたりの DB 操作は開始と終了の2回だけなので、複雑なロジックを直感的に実装できるようになりました。",
				],
			},
			{
				title: "AI の成果物を、人手をボトルネックにせずに検証する",
				body: [
					...
					"この問題を顧問に相談したところ、「ハーネスエンジニアリング」という概念を教わりました。ネットで検索してみると、「AI が正しい行動を取れるように環境を作ること」という曖昧な答えしか出てきませんでした。概念を完全には理解できませんでしたが、顧問の助言を受けてフック、批判的レビュアー、テスターを一つずつセットアップしていくうちに、いつの間にか自分だけのハーネスができあがっていました。",
					"ハーネスで一番難しいのは、「成功条件」を定義することです。たとえば Figma で定義されたデザインどおりに画面を実装できたかを判定するには、そのデザインと実装された画面が一致しているかを評価するロジックが必要です。最初はアプリの画面をキャプチャして似ているかどうかだけを調べ、独立したサブエージェントがこの比較を担当しました。悪くはありませんでしたが、良い成果物とも言えませんでした。あちこちでアイコンが違い、テキストの位置がずれていました。何より、アプリの画面をキャプチャして Figma と照らし合わせる作業がとても遅く、トークンを大量に消費しました。",
					ENQOR_FIGURES.harness,
					"この問題は expo web で解決しました。まず実装したい画面を expo web で動かせば、ヘッドレスブラウザを開いて実装の状態を難なく確認できます。ウィンドウサイズを変えるだけで、モバイル・タブレットの解像度で崩れる部分がないかもすぐにわかります。こうしてウェブでの実装が終わったコードをアプリに移す順番に変えると、評価のコストが大きく下がりました。Figma とウェブ上の画面がどれだけ似ているかは批判的エージェントが判定しますが、アイコンを自分で生成できないようにルールを入れ、Figma MCP に問題が起きて動かない場合はハーネスがそもそも止まるようにする preflight の手順も追加しました。その結果、シンプルな画面はほぼ完璧なレベルで、複雑な画面も70%ほどの完成度で仕上がりました。",
				],
			},
		],
	},
	retrospective: {
		label: "Retrospective",
		paragraphs: [
			"今回の経験で、AI に良い資料と環境を与えれば、それに見合う結果が出るとわかりました。そして AI が生み出した結果も、「どう」検証するかより「どこまで」検証するかを考えるほうが正しいと感じました。",
...
const waterflakeStory: ProjectStoryContent = {
	tagline: "簡単なインストールだけで、マインクラフトサーバーにドメインで接続できるようにする",
	highlights: [
	...
	motivation: [
		"10年ほど前、マインクラフトというゲームにはまり、みんなで遊べるサーバーを立てることが一番の目標でした。コンピューターのことなどまったく知らない小学生が、ブログの記事だけを読んで VPS サーバーを借り、Linux 環境でゲームサーバーを動かしました。そして複雑なネットワークの設定までこなして、ついにサーバーを公開しました。そのときの達成感は人生で最も大きく、決して忘れられない思い出です。そして今、「もし複雑な手順なしに、簡単にゲームサーバーを公開できるツールがあったらどうだろう？」という考えから始めました。",
	],
	architecture: {
		label: "Architecture",
		items: [
			{
				title: "SRV レコードで、サブドメインが特定の IP のポートを指すよう自動で設定する",
				body: [
					WATERFLAKE_ARCHITECTURE,
					"ユーザーが WATERFLAKE のウェブ画面でトンネルを作成すると、Cloudflare API を通じて SRV レコードを作成します。そして、トンネリングを担当する仮想マシン上に、ランダムなポートでトンネリングサーバーを立ち上げます。トンネリングサーバーは2つの接続を受けます。1つは SRV レコードを通じて入ってくる接続、もう1つはマインクラフトのサーバー側へ出ていく接続です。この2つの接続をパイプでつなぐことで、外部から入ってくるパケットが自然にマインクラフトのサーバーへ流れていきます。ユーザーには、まるでドメインのアドレスを入力すれば接続できるサーバーのように見えます。",
				],
			},
			{
				title: "ゲームサーバーとトンネリングサーバーの間を、TCP ソケットでトンネリングする",
				body: [
	...
	featured: [
		{
			period: "2025 ~ 現在",
			title: "コスモのノート",
			description: "溜まった講義動画を短時間で消化するための動画要約サービスです。音声だけでなく画面の中のスライドまで読み、サブスクリプションなしで、使った分だけ支払う仕組みにしました。",
		...
		},
		{
			period: "2026 ~ 現在",
			title: "enqor",
			description: "リアルタイムのビデオ・音声で、専門家と1対1で相談できるサービスです。秒単位の通話課金機能と、AI エージェントの成果物を、人手をボトルネックにせずに検証するハーネスを作りました。",
	...
	archive: [
		{
			period: "2024",
			title: "HEALIX",
			description: "症状をもとに、最も近くて適切な病院をおすすめするサービスです。韓国の公共データポータルの病院情報とアプリ内の GPS データを、AI に渡すようにしました。",
		...
		},
		{
			...
			title: "スクリーン翻訳機",
			description:
				"スマートフォンを振ると画面をキャプチャし、オーバーレイで訳文を表示します。中学生のときに初めて作り、収益化にも成功しました。",
...
const REALTIME_ITEM: Media = {
	...
	alt: "DynamoDB のアイテムの図。パーティションキーはユーザー1人に割り当てられ、その中の boxes 配列に id・cash・opened の値を持つボックスが並んでいる。API は新しいボックスを配列に追加し、ボックスを開けるとその項目に cash の値を書き込む",
};
...
const REALTIME_OPEN: Media = {
	...
	alt: "ボックスを開けるフロー図。アプリがボックスを開けると、サーバーが MySQL から設定を読み(read config)、Redis で高額当選の TTL フラグを確認したあと(check ttl)、DynamoDB のボックスを開封済みに変えて ZSET のランキングを更新する(set open & add rank)。最後に、アプリにキャッシュ（アプリ内通貨）が付与される",
};
	...
	highlights: [
		{
			...
			body: [
				{ heading: "背景" },
				"Timespread には、ランダムボックスという機能があります。広告を見るとアプリ内通貨の「キャッシュ」がランダムに入ったボックスがもらえ、そのボックスを開けるとキャッシュが入るというシンプルな機能でした。ボックス1つは、luckybox テーブルの1行でした。ユーザーが増えるにつれてこのテーブルに19億件が積み上がりましたが、主キーが INT で宣言されていたため、上限の21億まで2か月ほどしか残っていない状態でした。このテーブルを、BIGINT で宣言した新しいテーブルに移す必要がありました。",
				{ heading: "1回目の試み" },
				"まず、サービスの特徴を調べました。ボックスは24時間が過ぎると期限切れになり、ランキングを処理するバッチプログラムは直近1か月のデータしか読んでいませんでした。メンテナンス時間内にこのデータだけを移せば、サービスを再開できるとわかりました。",
				BIGINT_TABLE,
				...
				{ heading: "2回目の試み" },
				"チームリーダーと解決策を話し合っているうちに、ふと INT には負の領域もあることを思い出しました。幸い unsigned で宣言されていなかったので、PK を負数で保存する方法について話し合いました。チームリーダーも良い方法だと言ってくれたので、すぐに作業に取りかかりました。",
				BIGINT_TRIGGER,
		...
		},
		{
			...
			body: [
				{ heading: "背景" },
				"先のマイグレーションで時間を稼いだ直後から、次の作業の準備に入りました。まず、アプリで ID を整数として扱っていたのを String に変え、そのリリースがユーザーの99%に行き渡るまで待ちました。ちょうど運営チームから、ランダムボックスの確率調整機能がわかりにくいのでリニューアルしてほしいという要望があり、代表の承認も得られたので、ようやくリファクタリングに着手できました。ボックスサービスの /luckybox エンドポイントは、当時毎分1,500件前後のリクエストを受けていました。",
		...
		},
		{
			...
			subtitle: "安くて性能の良い Graviton インスタンスに移し、オートスケーリングのルールを組み直しました。",
			body: [
				{ heading: "背景" },
				"Timespread は、サーバー費用として毎月100万円を超える金額を使っていました。チームリーダーから、この費用を減らす方法を探してみようと言われました。",
				...
				AWS_ROUTE53,
				"テストサーバーで QA チームと一緒にサーバーが正しく動くかを確認したところ、何の問題もありませんでした。Route 53 の加重ルーティングで新しいサーバーにトラフィックの10%だけを流し、大きな問題が出なかったので、最終的にすべてのトラフィックを Graviton インスタンスが受けるようにしました。",
				{ heading: "オートスケーリングのルールを組み直す" },
				"数日後には、CPU 使用率のデータを見て、時間帯ごとのスケールアウトのルールを調整しました。ピーク時に最大12台まで増えていたインスタンスを8台に減らし、夜間は1台だけ動くようにしました。インスタンスの切り替えとスケーリングルールの調整を合わせて、最終的に費用を30%ほど削減できました。",
			],
		},
		{
			slug: "api-memory",
			year: "2022",
			title: "メモリ 32GB を使い切って停止していた API サーバーの正常化",
			...
			body: [
				...
				{ heading: "メモリダンプを取る" },
				"チームリーダーから、本番サーバーのメモリダンプを取って調べてみようというアイデアをもらいました。正直、気が進みませんでした。ダンプを取っている間にサービスに障害が出るかもしれず、ダンプを持ってきても読み方がわからないので、意味のある結果を見つけるのは難しそうでした。それでも他に方法がなく、ひとまずやってみることにしました。",
				"調べてみると、メモリダンプのツールがいくつかありました。チームリーダーに共有し、本番サーバーに直接アクセスして、2つのツールでメモリをスキャンしました。1つ目のツールでは何も得られませんでしたが、2つ目のツールで、同じエラーが何度も発生したと思われるダンプのログを見つけました。",
				{ heading: "原因と解決" },
				"原因は、アプリのプッシュ送信を並列化したコードにありました。並列処理のためにスレッドを作るのですが、スレッドの中で例外が発生すると、そのスレッドが回収されずにそのまま残り、メモリリークが積み重なっていました。スレッド内部の処理ロジックに try/catch を付けてデプロイすると、それ以降すべてのインスタンスが1GB ほどしか使わない正常な状態に戻りました。",
...
export const certificates: CertificatesContent = {
	...
	items: [
		...
		},
		{
			...
			title: "最優秀賞（全体1位）",
			detail: "東亜大学校 総長賞",
			description: "**コスモのノート**で、韓国全土から13チームが集まった大会で受賞しました。",
		...
		{
			period: "2024",
			event: "LIKELION 大学 第12期 中央ハッカソン",
			title: "最優秀賞（全体2位）",
			detail: "Younglimwon Soft Lab（韓国の ERP 企業）特別賞",
			description: "**HEALIX**で、韓国の IT 教育企業 LIKELION が主催し、韓国全土の55校から1,500人あまりが集まったハッカソンで受賞しました。",
			...
			gallery: [
				{
					...
					height: 1980,
					caption: "最優秀賞",
					alt: "LIKELION 大学 第12期 中央ハッカソン 最優秀賞、Younglimwon Soft Lab 特別賞の賞状",
				},
			],
		},
		{
			period: "2025",
			title: "国家優秀奨学金（理工系）",
			detail: "韓国・科学技術情報通信部長官 証書",
			description: "韓国で約1,000人しか選ばれない国家優秀奨学金（理工系）を受給しました。",
		...
		},
		{
			...
			description: "韓国の地域コミュニティアプリを運営する Daangn（海外名 Karrot）が20人ほどを選抜する少人数制のハッカソンに選ばれました。",
...
const DREAM_PHOTOS: readonly Media[] = [
	{
		...
		note: "卒業式のスクリーンに映った、当時の将来の夢は「コンピュータープログラマー」。",
			...
			events: [
				{
					...
					featured: true,
					detail: "VPS サーバーを借りてサーバーを構築し、最大同時接続者数120人を記録しました。",
				},
				{
					year: "2015",
					title: "小学校を卒業",
					detail: "**将来の夢**に書いたコンピュータープログラマーへの思いは、今も続いています。",
				...
				},
				{
					...
					featured: true,
					detail: "PHP で動く少人数グループ向けのサービスを開発し、会員100人ほどを集めました。",
				...
				},
				{
					...
					featured: true,
					detail:
						"スマートフォンを振ると画面の上に翻訳のオーバーレイを表示するアプリを開発し、1,000ダウンロードを記録して収益化も経験しました。",
			...
			events: [
				{
					year: "2022",
					title: "**メモリ 32GB を使い切って停止していた** API サーバーの正常化",
					links: [{ name: "メモリ 32GB を使い切って停止していた", href: "/experience/api-memory" }],
				},
				{
					year: "2022",
					title: "**月100万円を超えていた AWS 費用を**30%削減",
					links: [{ name: "月100万円を超えていた AWS 費用を", href: "/experience/aws-cost" }],
				},
				{
					year: "2023",
					title: "**19億件のテーブルを**メンテナンス1時間以内にマイグレーション",
					featured: true,
					links: [{ name: "19億件のテーブルを", href: "/experience/bigint-migration" }],
				},
				{
					year: "2023",
					title: "**毎分1,500件のリクエストを受ける**サービスのリファクタリング",
					featured: true,
					links: [{ name: "毎分1,500件のリクエストを受ける", href: "/experience/realtime-redesign" }],
				},
			],
		},
		{
			...
			events: [
				{
					year: "2024",
					title: "LIKELION 大学 第12期 中央ハッカソン 2位",
					detail: "**HEALIX**で、韓国の IT 教育企業 LIKELION が主催し、韓国全土の55校から1,500人あまりが集まったハッカソンで受賞しました。",
					links: [{ name: "HEALIX", href: "/projects/healix" }],
				},
				{
					year: "2024",
				...
				},
				{
					year: "2025",
					title: "国家優秀奨学金（理工系）",
					detail: "韓国で約1,000人しか選ばれない国家優秀奨学金（理工系）を受給しました。",
				},
				{
					year: "2025",
					title: "日本・鳥取大学へ交換留学",
				...
				},
				{
					...
					featured: true,
					detail: "**コスモのノート**で、韓国全土から13チームが集まった大会で受賞しました。",
					links: [{ name: "コスモのノート", href: "/projects/cosmonote" }],
				},
				{
					year: "2026",
					title: "Align Networks リードエンジニア（契約社員）",
